...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <section class="spacer yellow mt-4 mb-4 p-4">
                <div class="container">
                    <div class="row pt-4 pb-3 " style="color: white">
                        <div class="col-md-6 offset-md-1">

                            <div class="span6 alignright flyLeft text-end">
                                <blockquote class="h1">
                                    La sala scherma resterà chiusa da venerdì 19 a lunedì 22 aprile.
                        ...
                        <div class="col-md-5 text-center">
                            <div class="span6 aligncenter flyRight">
                                <i class="fa-solid fa-bell" style="font-size: 120px"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="owl-description" style="color:#666666;">Da circa 40 anni il C.S. Santa Maria propone corsi
                        di insegnamento delle principali discipline sportive per adulti e bambini, secondo i programmi delle
                        varie Federazioni sportive nazionali, seguiti da uno staff di tecnici altamente qualificati in un
